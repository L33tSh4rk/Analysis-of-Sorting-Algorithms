...
Mede o tempo de execução, número de comparações e trocas para diferentes tamanhos de arquivos de dados armazenados em binários. 
Também gera gráficos para análise dos resultados.
